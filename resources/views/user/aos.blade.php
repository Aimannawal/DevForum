...
<head>
    ...
    <title>DevEdu - Package Detail</title>
    ...
    <main class="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8">
        <div class="px-4 sm:px-0">
            <div class="flex items-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900">AOS</h1>
                <span class="ml-4 px-3 py-1 text-sm font-medium bg-accent/10 text-accent rounded-full">Animation
                    Library</span>
            </div>

            <div class="bg-white shadow-lg rounded-xl overflow-hidden mb-8">
                <div class="relative w-full" style="padding-top: 56.25%">
                    <video src="assets/vid/aos.mp4" class="absolute top-0 left-0 w-full h-full object-cover"
                        controls></video>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <div class="px-6 py-4 bg-accent text-white flex items-center justify-between">
                    ...
                    <span class="text-sm bg-white/20 px-3 py-1 rounded-full">v2.3.4</span>
                </div>
                    ...
                    <div class="p-8">
                        ...
                        <div class="relative">
                            <pre class="bg-gray-900 rounded-xl p-4 overflow-x-auto">
                                <code class="text-sm text-gray-200">npm install aos --save</code>
                            </pre>
                            <button
...
// In your JSX:
&lt;div data-aos="fade-up"&gt;This will animate&lt;/div&gt;
                                </code>
                            </pre>
                            <button
                                class="absolute top-3 right-3 p-2 bg-gray-800 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition duration-150 ease-in-out">
